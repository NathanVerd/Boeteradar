          ...
          <div className="mt-6 grid gap-5">
            ...
            <label className="font-bold">
              ...
              >
                ...
                <option value="yes-not-checked">Ja, maar ik controleerde het niet</option>
        ...
        <section className="mt-6 rounded-[2rem] bg-white p-7 shadow-sm md:p-8">
          ...
          <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-700">
              ...
              mogelijk te laat. In MyMinfin zie ik [status]. Ik heb
              [wel/geen] bericht ontvangen en mijn documenten zijn
              [klaar/nog niet klaar]. Kan je nakijken wat ik nu best doe?”
            </p>
          </div>
        </section>
